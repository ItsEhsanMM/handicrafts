                    ...
                    <div>
                            ...
                            <div className='w-[1019px] h-[460px] flex justify-between flex-wrap'>
                                {   slider.map(slid => (
                                    <div className='text-[#ffff]  w-[327px] relative flex justify-center max-w-[506px] h-[222px] rounded-2xl bg-green-400'>
                                        <img className='w-[100%] rounded-2xl h-[100%]' src="https://presite.ir/Handicrafts/wp-content/uploads/2022/10/dynamic-island.jpg" alt="" />
                        ...
                        <div className='py-[25px]'>
                            <div className='flex items-center'>
                                ...
                                <div className='border-dotted w-[100%] h-[1px] border-[1px]'>
                                    ...
                                    number.map(num => (
                                        <div className='w-[310px] h-[466px] border-[2px] border-zinc-200 rounded-2xl'>
                                            <div className='h-[200px]  w-[100%]'>
                                                <img className='w-[100%] h-[100%] rounded-t-2xl' src="https://presite.ir/Handicrafts/wp-content/uploads/2022/10/blog-new-11.jpg" alt="" />
                                            </div>
                                            <div className='flex flex-col gap-[1.25rem] pr-[.5rem]'>
                                                <span className='text-[13px] text-zinc-600'>4 دقیقه زمان مطالعه</span>
                                                ...
                                                <div className='flex justify-between'>
                                                    <div className='flex items-center   gap-[.5rem] flex-row-reverse'>
                                                        ...
                                                        <span className='text-[13px] text-zinc-500'>3 سال قبل</span>
                        ...
                        <div className=' py-[4.5rem] flex items-center justify-center w-[100%]'>
                            <img className='w-[100%]' src="https://presite.ir/Handicrafts/wp-content/uploads/2022/10/blog-banner-2-1.png" alt="" />
                        </div>
                    </div>
                </main>
                <footer>
