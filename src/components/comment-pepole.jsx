...
export default function CommentPepole() {
    ...
    return (
        <div className='flex flex-col items-start px-4' dir="rtl">
            {/* باکس بالایی (عنوان) */}
            <div className='bg-[#4D1] w-full max-w-[630px] h-auto flex flex-col items-end p-5 rounded-3xl text-right'>
                <div className='text-right w-full'>
                    <span className='font-bold text-lg block mb-2'>نظرات مشتریان ما</span>
                </div>
            ...
            <div className='mt-6 py-[2.5rem] w-full'>
                ...
                >
                    ...
                    {test2.map(test => (
                        <SwiperSlide>
                            <div className='w-full max-w-[350px] h-auto p-4 relative rounded-2xl bg-white shadow-md text-right' dir="rtl">
                                <span className='block text-sm leading-relaxed text-gray-700'>
                                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است،
                                    چاپگرها لورم ایپسوم متن ساختگی در صنعت می‌باشد.
                                </span>
                                ...
                                <div className='flex items-center gap-3 mt-4'>
                                    ...
                                    <div className='flex flex-col text-right'>
                                        <span className='font-semibold text-sm'>فرزانه احمدی</span>
