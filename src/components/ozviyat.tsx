            ...
            <main>
               <div className="flex justify-between py-[2.5rem]">
                  <div className="flex flex-col gap-[1.5rem]">
                     <span className="text-[16px]">عضویت</span>
                     <div className="w-[624px] gap-[0.5rem]  flex flex-col rounded-[19px] p-[20px] bg-[#F8F8F8]">
                        <div className="flex flex-col h-fit  gap-[.5rem] ">
                           <div className=" w-full flex flex-col gap-[0.75rem] ">
                              ...
                              <input
                                 className="w-[100%] bg-[#FFFFFF] min-h-[43px]  rounded-[9px]"
                                 type="text"
                              />
                           </div>
                        ...
                        <div className="flex h-fit flex-col gap-[1rem]">
                           <span className="cursor-pointer text-zinc-500">
                              اطلاعات شخصی شما برای پردازش سفارش شما استفاده
                              می‌شود، و پشتیبانی از تجربه شما در این وبسایت، و
                              برای اهداف دیگری که{" "}
                              <span className="hover:text-green-500">
                                 در سیاست حفظ حریم خصوصی
                              </span>{" "}
                              توضیح داده شده است.
                           </span>
